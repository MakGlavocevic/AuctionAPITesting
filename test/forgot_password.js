...
describe('Forgot password: TS-010', () => {
    ...
    it('User wants to retrieve new password via the forgot password functionality using invalid data: 10.001', async () => {
    ...
    it('User wants to retrieve new password via the forgot password functionality using invalid data: 10.002', async () => {
